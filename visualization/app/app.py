...
set_source_point_cloud_service = roslibpy.Service(ros_client, '/registration_api/source/set', 'registration_msgs/String')
set_destination_point_cloud_service = roslibpy.Service(ros_client, '/registration_api/destination/set', 'registration_msgs/String')
UPLOAD_FOLDER = '/home/richard/point-cloud-registration/docker/context/upload'
